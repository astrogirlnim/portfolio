          ...
          <div className="container">
            ...
            <div className="mb-12" id="project-lapack-ai">
              <VideoProjectShowcase
                ...
                video={getAssetPath("videos/LAPACK_DEMO_FINAL_compressed.mp4")}
            ...
            <div className="mb-12" id="project-marketsnap">
              <VideoProjectShowcase
                ...
                video={getAssetPath("videos/Final_Demo_V2_compressed.mp4")}
            ...
            <div className="mb-12" id="project-children-of-singularity">
              <VideoProjectShowcase
                ...
                video={getAssetPath("videos/ChildrenOfSingularity_Demo_compressed.mp4")}
            ...
            <div className="mb-12" id="project-personyx">
              <VideoProjectShowcase
                ...
                video={getAssetPath("videos/Personyx_Demo_compressed.mp4")}
